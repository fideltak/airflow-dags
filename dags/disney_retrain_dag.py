...
from disney_common import DEFAULT_ARGS, JST, RETRAIN_SCHEDULE, make_task
...
with DAG(
    ...
    train = make_task(
        "train_model", ["train"],
        memory="6Gi", cpu="2", retries=1, retry_delay_minutes=10,
    ...
    cleanup = make_task(
        "cleanup", ["cleanup"],
        memory="512Mi", cpu="500m", retries=0, timeout_minutes=15,
