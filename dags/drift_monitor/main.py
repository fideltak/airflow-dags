...
def dag_tasks(config):
    ...
    def generate_token(**context):
        from drift_monitor.pkg import token
    ...
    def list_trace_files(**context):
        ...
        from drift_monitor.pkg import s3
    ...
    def get_mlflow_artifacts(**context):
        ...
        from drift_monitor.pkg import mlflow
    ...
    def check_data_drift(**context):
        ...
        from drift_monitor.pkg import whylogs
        drift_metrics = whylogs.check_data_drift(train_query_df, trace_query_df)
    ...
    def slack_notify(**context):
        ...
        if slack_token and slack_channel:
            from drift_monitor.pkg import slack
